...
describe('test storage with s3 account', function () {

    var config = JSON.parse(fs.readFileSync('./tests/test-config/s3.json'));
    var storageClient;
...
describe('test storage with azure account', function () {

    var config = JSON.parse(fs.readFileSync('./tests/test-config/azure.json'));
    var storageClient;
...
describe('test storage with google account', function () {

    var config = JSON.parse(fs.readFileSync('./tests/test-config/google.json'));
    var storageClient;
